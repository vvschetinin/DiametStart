...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const elementArray: Element[] = Array.from(elements);

  // Функция для перемешивания массива (Fisher-Yates shuffle для случайного выбора без повторений)
  ...
  // Перемешиваем и выбираем первые два элемента
  const shuffledElements = shuffleArray(elementArray);
